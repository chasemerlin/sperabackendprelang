...
class GroupMembershipsControllerTest < ActionController::TestCase
  ...
  test "should create group_membership" do
    assert_difference('GroupMembership.count') do
      post :create, group_membership: { group_id: @group_membership.group_id, inviter_id: @group_membership.inviter_id, status: @group_membership.status, user_id: @group_membership.user_id }
    end
  ...
  test "should update group_membership" do
    patch :update, id: @group_membership, group_membership: { group_id: @group_membership.group_id, inviter_id: @group_membership.inviter_id, status: @group_membership.status, user_id: @group_membership.user_id }
    assert_redirected_to group_membership_path(assigns(:group_membership))
  end
